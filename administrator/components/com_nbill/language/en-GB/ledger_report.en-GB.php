...
define("NBILL_LEDGER_REPORT_INTRO", "This report shows a breakdown of the income and expenditure against each nominal ledger code. You can expand each ledger code to see the individual items that make up the total.");
