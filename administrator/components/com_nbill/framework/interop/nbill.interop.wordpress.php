...
class nbf_interop_wordpress extends nbf_interop
{
    ...
    */
    protected function initialise()
    {
        ...
        if (!get_magic_quotes_gpc() && !isset($_POST['nbill_slashes_stripped'])) {
            ...
            $_POST['nbill_slashes_stripped'] = '1'; //Don't do it again
        }
    }

    public function terminate()
    {
        if (array_key_exists('POST', $this->hold_globals)) {
    ...
    */
    ...
    {
        return get_option('users_can_register') ? "wp-login.php?action=register" : "";
    }
